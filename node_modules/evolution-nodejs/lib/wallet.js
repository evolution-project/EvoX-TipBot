...
// transfer EvoX to a single recipient, or a group of recipients
Wallet.prototype.transfer = function(destinations, options) {
    ...
    let params = {
        destinations: destinations,
        mixin: parseInt(options.mixin) || 6,
...
// helper function to convert EvoX amount to atomic units
